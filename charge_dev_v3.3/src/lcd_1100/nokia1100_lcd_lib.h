...
#define SCLK_LCD_PIN    GPIO_ODR_ODR3
#define SDA_LCD_PIN     GPIO_ODR_ODR2
#define CS_LCD_PIN      GPIO_ODR_ODR1
#define RST_LCD_PIN     GPIO_ODR_ODR0
